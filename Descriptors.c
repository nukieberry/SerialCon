...
const USB_Descriptor_Configuration_t PROGMEM ConfigurationDescriptor = {
	...
	.HID_Interface0 =
		{
			...
			.InterfaceNumber        = INTERFACE_ID_Joystick0,
	...
	.HID_ReportINEndpoint0 =
		{
			.Header                 = {.Size = sizeof(USB_Descriptor_Endpoint_t), .Type = DTYPE_Endpoint},

			.EndpointAddress        = JOYSTICK_IN_EPADDR0,
			.Attributes             = (EP_TYPE_INTERRUPT | ENDPOINT_ATTR_NO_SYNC | ENDPOINT_USAGE_DATA),
			.EndpointSize           = JOYSTICK_EPSIZE,
			.PollingIntervalMS      = 0x01
		},

	.HID_ReportOUTEndpoint0 =
		{
			.Header                 = {.Size = sizeof(USB_Descriptor_Endpoint_t), .Type = DTYPE_Endpoint},

			.EndpointAddress        = JOYSTICK_OUT_EPADDR0,
			.Attributes             = (EP_TYPE_INTERRUPT | ENDPOINT_ATTR_NO_SYNC | ENDPOINT_USAGE_DATA),
			.EndpointSize           = JOYSTICK_EPSIZE,
			.PollingIntervalMS      = 0x01
		},
	...
	.HID_ReportINEndpoint1 =
		{
			...
			.EndpointAddress        = JOYSTICK_IN_EPADDR1,
			.Attributes             = (EP_TYPE_INTERRUPT | ENDPOINT_ATTR_NO_SYNC | ENDPOINT_USAGE_DATA),
			.EndpointSize           = JOYSTICK_EPSIZE,
			.PollingIntervalMS      = 0x01
		},
	...
	.HID_ReportOUTEndpoint1 =
		{
			...
			.EndpointAddress        = JOYSTICK_OUT_EPADDR1,
			.Attributes             = (EP_TYPE_INTERRUPT | ENDPOINT_ATTR_NO_SYNC | ENDPOINT_USAGE_DATA),
			.EndpointSize           = JOYSTICK_EPSIZE,
			.PollingIntervalMS      = 0x01
		},		
...
uint16_t CALLBACK_USB_GetDescriptor(
	...
	switch (DescriptorType)
	{
		...
		case DTYPE_HID:
			switch (wIndex)
			{
				case (INTERFACE_ID_Joystick0):
					Address = &ConfigurationDescriptor.HID_JoystickHID0;
					Size    = sizeof(USB_HID_Descriptor_HID_t);
					break;
				case (INTERFACE_ID_Joystick1):
					Address = &ConfigurationDescriptor.HID_JoystickHID1;
					Size    = sizeof(USB_HID_Descriptor_HID_t);
